...
SceneManager = {current_active_scene_index = 1, game_scenes = {LogoScene, CombatScene}}
...
function SceneManager:open_scene(scene_index) 
    ...
    if SceneManager.game_scenes[scene_index] then
        ...
        print("SceneManager: provided scene index is garbage. Provided scene: ", scene_index)
    end
end
